...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // PORTA AUTOMÁTICA
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // VIDA UTIL POR CLASSE (POR ME 
public class UsuarioRepositoryTest {
  
	@Autowired  // USA O QUE ESTÀ NA CLASSE
	private UsuarioRepository usuarioRepository;

	@BeforeAll  // Insert no BD
	void start(){
